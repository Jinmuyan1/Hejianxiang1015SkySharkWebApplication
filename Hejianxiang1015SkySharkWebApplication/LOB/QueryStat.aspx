<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="QueryStat.aspx.cs" Inherits="HejianxiangProject4SkySharkWebApp.LOB.QueryStat" %>
            ...
            <WizardSteps>
                <asp:WizardStep ID="WizardStep1" runat="server" Title="Query Flight Status">
                    ...
                    <table >
                        <tr>
                            <td colspan ="2">
                                <asp:Label ID="Label2" runat="server" Text="Enquire about the status of flights" BorderStyle="Inset" Font-Names="Microsoft Sans Serif"></asp:Label></td>
                            <td></td>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:Calendar ID="CalDepDate" runat="server" BackColor="White" BorderColor="Black" BorderStyle="Double" Border="2px" DayNameFormat="FirstTwoLetters" ></asp:Calendar>
                            </td>
                            <td></td>
                            <td></td>
                        </tr>
                ...
                <asp:WizardStep ID="WizardStep2" runat="server" Title="Query Ticket Status">
                    ...
                    <table>
                         <tr>
                <td colspan ="2">
                    <asp:Label ID="Label7" runat="server" Text="Enquire Ticket Status" BorderStyle="Inset" Font-Names="Microsoft Sans Serif"></asp:Label></td>
                <td></td>
